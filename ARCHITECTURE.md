...
| Module | Path | Purpose |
|--------|------|---------|
| CLI | `bin/forgedocs.mjs` | Entry point — routes subcommands (init, quickstart, dev, build, add, remove, status, score, badge, diff, lint, check, audit, export, watch, install, doctor, mcp) |
